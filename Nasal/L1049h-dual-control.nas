...
var nav_cmd           = ["instrumentation/nav[0]/frequencies/selected-mhz", 
                         ...
                         "instrumentation/nav[2]/frequencies/standby-mhz",
                         "instrumentation/nav[3]/frequencies/selected-mhz", 
                         "instrumentation/nav[3]/frequencies/standby-mhz"];
  ...
  return [
      ...
      DCT.SwitchEncoder.new
        ([
          ...
          props.globals.getNode(ap_switch[8]),
...
var copilot_connect_pilot = func (pilot) {
  ...
  return [
      ...
      DCT.Translator.new(props.globals.getNode(ap_switch[8], 1), pilot.getNode("/"~ap_switch[8])),
      ...
      DCT.MostRecentSelector.new(props.globals.getNode("dual-control/pilot/"~nav_cmd[4], 1), props.globals.getNode(nav_cmd[4]), props.globals.getNode(nav_cmd[4]), 0.01),
      DCT.MostRecentSelector.new(props.globals.getNode("dual-control/pilot/"~nav_cmd[5], 1), props.globals.getNode(nav_cmd[5]), props.globals.getNode(nav_cmd[5]), 0.01),
      DCT.MostRecentSelector.new(props.globals.getNode("dual-control/pilot/"~nav_cmd[6], 1), props.globals.getNode(nav_cmd[6]), props.globals.getNode(nav_cmd[6]), 0.01),
      DCT.MostRecentSelector.new(props.globals.getNode("dual-control/pilot/"~nav_cmd[7], 1), props.globals.getNode(nav_cmd[7]), props.globals.getNode(nav_cmd[7]), 0.01),
      ...
      DCT.MostRecentSelector.new(props.globals.getNode("dual-control/pilot/"~instr_cmd[10], 1), props.globals.getNode(instr_cmd[10]), props.globals.getNode(instr_cmd[10]), 0.01),
      # TDM_mpp2
